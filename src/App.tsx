      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="animate-fade-in-up">
            ...
            Mehmet Halit
            <span className="block text-highlight">Barut</span>
          </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                ...
                className="bg-accent hover:bg-highlight text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center gap-2"
              >
              ...
              <a 
                href="#contact" 
                className="border-2 border-highlight text-highlight hover:bg-highlight hover:text-primary px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
              >
                İletişime Geç
              </a>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="bg-gradient-to-br from-secondary to-primary p-8 lg:p-10 rounded-2xl border border-accent">
              ...
              <form className="space-y-6 lg:space-y-8">
                <input
                  type="text"
                  className="w-full px-6 py-4 bg-primary border border-accent rounded-xl text-white placeholder-text-secondary focus:border-highlight focus:outline-none transition-colors"
                ...
                <textarea
                  rows={6}
                  className="w-full px-6 py-4 bg-primary border border-accent rounded-xl text-white placeholder-text-secondary focus:border-highlight focus:outline-none transition-colors resize-none"
                  placeholder="Mesajınızı buraya yazın..."
                ></textarea>
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-accent to-highlight hover:from-highlight hover:to-accent text-white py-4 px-8 rounded-xl transition-all duration-300 font-semibold text-lg transform hover:scale-105 hover:shadow-lg"
                >
                  Mesaj Gönder
                </button>
              </form>
