...
export default function Projects() {
  ...
  return (
    <div className="relative bg-transparent">
      {/* Background Glows: Royal Blue (top-right) + Neon Green (bottom-left) */}
      <div className="absolute top-10 -right-20 w-[500px] h-[500px] bg-[#2563eb] opacity-35 blur-[100px] rounded-full pointer-events-none animate-float-slow" />
      <div className="absolute bottom-10 -left-20 w-[500px] h-[500px] bg-[#39ff14] opacity-25 blur-[90px] rounded-full pointer-events-none animate-float-reverse" />
